...
import { HeaderDetail } from "@/styles/sidebar.style";
...
const BusinessDashboardHeader = () => {
  ...
  return (
    ...
    >
      <div className="heaser-detail">
        <ToggleButton onToggleNavigation={() => onToggleSideNavigation()} />
        <div className="profile-detail">
          <Language />
          <Notification />
          <AccountMenu setIsSignOutModalOpen={setIsSignOutModalOpen} />
        </div>
        {isSignOutModalOpen ? (
          <ConfirmationDialog
            isOpen={isSignOutModalOpen}
            modalTitle={t("auth.business.login.confirmation.title")}
            description={t("auth.business.login.confirmation.description")}
